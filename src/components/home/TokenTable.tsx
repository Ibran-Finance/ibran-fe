            ...
            return (
              ...
              >
                ...
                <div className="flex items-center justify-between md:justify-start gap-3 pl-4">
                  ...
                  <span className="text-green-400 font-medium md:hidden">
                    {formatBalance()}
                  </span>
                </div>
                ...
                <div className="flex flex-row items-center justify-center gap-2 mt-2 md:mt-0">
                  ...
                  <Button
                    variant="outline"
                    className="w-1/2 md:w-auto bg-green-600 hover:bg-green-700 text-white border-green-500 text-xs px-2 py-1 md:text-sm md:px-3 md:py-2 h-8 md:h-auto"
                    onClick={() => {
