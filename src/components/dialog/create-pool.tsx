...
export const CreatePoolDialog: React.FC<CreatePoolDialogProps> = ({
  ...
  const handleSubmit = async () => {
    ...
    if (connectedChainId !== defaultChain) {
      setError(`Please switch to Core Testnet 2 (Chain ID: ${defaultChain})`);
      return;
    }
  ...
  return (
    <Dialog open={open} onOpenChange={(isOpen) => {
      ...
      <DialogContent className="bg-gray-900 text-gray-100 border border-cyan-800 w-[95vw] max-w-lg md:max-w-xl lg:max-w-2xl mx-2 md:mx-0 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <div className="flex items-center gap-3">
          ...
          {!isConnected ? (
              ...
              <div className="text-center space-y-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-yellow-200">
                    Please switch to Core Testnet 2 (Chain ID: {defaultChain})
                  </p>
                </div>
              </div>
            </div>
            ...
            <>
              ...
              <div className="flex flex-col md:flex-row justify-end gap-3 mt-4">
                <Button
                  variant="outline"
                  className=" text-gray-200 bg-red-600 border-0 hover:bg-red-700 w-full hover:text-gray-300 md:w-auto rounded-xl px-6 py-3 transition-all duration-200"
                  onClick={handleClose}
